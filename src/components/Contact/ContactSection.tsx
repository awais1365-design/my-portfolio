    ...
    <section
      ...
      <div className="flex flex-col justify-between gap-8">
        <div>
          ...
          <h4 className="text-accent text-2xl font-bold md:text-3xl">Your project deserves the best</h4>
          <p className="text-neutral mt-8">
            Developing modern UIs, powerful APIs, and end-to-end full-stack solutions
          </p>
        </div>
        ...
        <div className="space-y-2">
          ...
          <a
            ...
            <MsgIcon /> awais1365@gmail.com
          </a>
          <a
            href="tel:+92 3123456789"
            className="text-neutral hover:text-accent flex items-center gap-1 font-light transition-colors duration-300">
            <PhoneIcon /> +92 3499322232
          </a>
        </div>
      </div>
