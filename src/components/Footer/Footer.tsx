      ...
      <div className="relative z-20 grid grid-cols-1 items-start gap-20 md:grid-cols-2 md:gap-12">
        <div>
          <h5 className="mb-8 flex items-center gap-2">
            ...
            <span className="text-neutral text-lg font-medium">End-to-End Development Services</span>
          </h5>
          <p className="text-tertiary-content">
            Skilled in building real-world applications with modern and efficient development practices.
